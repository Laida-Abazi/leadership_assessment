...
class Assessments(Base):
    ...
    responses = relationship("Responses", back_populates="assessment")
    ...
    assessment_result = relationship("AssessmentResult", back_populates="assessment", cascade="all, delete-orphan")
